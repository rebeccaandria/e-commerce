  ...
  return (
    <div className="container">
      ...
      <main>
        ...
        <h2>Sur le produit "Peinture aérosol CRC Galva Shine Bordeaux Brillant"</h2>
        <div>
          <p className="infoAviS date">Date :</p>
          <p className="infoAviS">Commentaire :</p>
          <p className="infoAviS">Étoiles :</p>
        </div>
        <div className="aviS">
          <div className="avis">
            <p className="infoAvis textDate">17/06/2020</p>
            <div className="infoAvis commentaire">
              <p>Super calité !</p>
            </div>
            <div className="infoAvis">
              <img src="/maquette/etoile.jpg" alt="etoile d'evaluation" className="evaluationImg"></img>
              <img src="/maquette/etoile.jpg" alt="etoile d'evaluation" className="evaluationImg"></img>
              <img src="/maquette/etoile.jpg" alt="etoile d'evaluation" className="evaluationImg"></img>
              <img src="/maquette/etoile.jpg" alt="etoile d'evaluation" className="evaluationImg"></img>
            </div>
          ...
          <div className="avis">
            <p className="infoAvis textDate">02/04/2020</p>
            <div className="infoAvis commentaire">
              <p>Rendu magnifique, livraison rapide. Mon bras est super class en noir et bordeaux ! Merci à HéphaTech !</p>
            </div>
            <div className="infoAvis">
              <img src="/maquette/etoile.jpg" alt="etoile d'evaluation" className="evaluationImg"></img>
              <img src="/maquette/etoile.jpg" alt="etoile d'evaluation" className="evaluationImg"></img>
          ...
          <div className="avis">
            <p className="infoAvis textDate">13/12/2019</p>
            <div className="infoAvis commentaire">
              <p>Très bon produit, ne se craquel pas :)</p>
            </div>
            <div className="infoAvis">
              <img src="/maquette/etoile.jpg" alt="etoile d'evaluation" className="evaluationImg"></img>
              <img src="/maquette/etoile.jpg" alt="etoile d'evaluation" className="evaluationImg"></img>
          ...
          <div className="avis">
            <p className="infoAvis textDate">24/09/2019</p>
            <div className="infoAvis commentaire">
              <p>Sympa, facile à utiliser. Le rendu est très convinquant, je le conseil. La couleur est vive et le brillant très brillant. Je ne m'attendais à un sechage si rapide ! Je suis agréablement surprise XD</p>
            </div>
            <div className="infoAvis">
              <img src="/maquette/etoile.jpg" alt="etoile d'evaluation" className="evaluationImg"></img>
              <img src="/maquette/etoile.jpg" alt="etoile d'evaluation" className="evaluationImg"></img>
