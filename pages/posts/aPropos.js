  ...
  return (
    <div className="container">
      ...
      <main className="description">
        <h1>Comment acheter chez nous?<br></br>Rien de plus facile !</h1>
        <div className="buttonAPropos">
          <Link href="/posts/boutique">
            <h2>Shoppez ! </h2>
          </Link>
          <Link href="/posts/boutique">
            <img src="/maquette/ensemble_protheses.jpg" alt="image des produits" />
          </Link>
          <Link href="/posts/boutique">
            <p>Choississez le type de prothèse dont vous avez besoin. Une large gamme est disponible pour répondre à votre demande.</p>
          </Link>
        </div>
        <br></br>
        <br></br>
        <div className="buttonAPropos">
          ...
          <Link href="/posts/compte">
            <img src="/maquette/inscription.jpg" alt="image d'inscription" />
          </Link>
          <Link href="/posts/compte">
            <p>Créer votre compte et scanner votre ordonnance.</p>
          </Link>
        </div>
        <br></br>
        <br></br>
        <div className="buttonAPropos">
          <Link href="/posts/calendrier">
            <h2>Prenez RDV !</h2>
          </Link>
          <Link href="/posts/calendrier">
            <img src="/maquette/rdv.jpg" alt="image du rendez-vous" />
          </Link>
          <Link href="/posts/calendrier">
            <p>Nos experts seront là pour cerner vos besoins. Ensemble nous opterons pour la meilleure des prothèses.</p>
          </Link>
        </div>
        <br></br>
        <br></br>
        <h2>Enjoy Life !</h2>
        <img src="/maquette/dessin_hommes.jpg" alt="image d'un homme utilisant sa prothèse" />
        <p>Votre expert disponible en cas de besoin</p>
        <p className="contact">hepha-tech@support.com / 01 23 45 67 89</p>
      </main>
      ...
      <style jsx>{`
        ...
        .buttonAPropos {
          border-top: rgb(120, 116, 212) 2px solid;
          border-bottom: rgb(120, 116, 212) 2px solid;
          border-radius: 10px;
          cursor: pointer;
        }

        .buttonAPropos:hover {
          border-top: rgb(120, 116, 212) 4px solid;
          border-bottom: rgb(120, 116, 212) 4px solid;
          border-left: rgb(120, 116, 212) 4px solid;
          border-right: rgb(120, 116, 212) 4px solid;
