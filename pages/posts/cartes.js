  ...
  return (
    <div className="container">
      ...
      <main className="description">
        <h1 className="title">Voici vos cartes :</h1>
        <div>
          <p className="infoCartes marque">Marque :</p>
          <p className="infoCartes">Numéro de la carte enregistrée :</p>
          <p className="infoCartes">Supprimer :</p>
        </div>
        <div className="cartes">
          <img src="/maquette/visa.jpg" alt="logo de visa" className="logoCarte"></img>
          <p className="textCarte">**** **** **** 7890</p>
          <img src="/maquette/supprimer.jpg" alt="effacer une carte" title="supprimer" className="buttonSupprimerCarte"></img>
          <br></br>
          <br></br>
          <img src="/maquette/americanExpress.png" alt="logo d'Américan Express" className="logoCarte"></img>
          <p className="textCarte">**** **** **** 5827</p>
          <img src="/maquette/supprimer.jpg" alt="effacer une carte" title="supprimer" className="buttonSupprimerCarte"></img>
          <br></br>
          <br></br>
        </div>
        <button className="ajoutCarte">ajouter une carte</button>
      </main>
