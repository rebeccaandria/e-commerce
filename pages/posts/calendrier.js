  ...
  return (
    <div className="container">
      ...
      <main className="description">
        <img src="/maquette/rdv_Sept.png" alt="Calendrier septembre"/>
        <img src="/maquette/rdv_Oct.png" alt="Calendrier octobre"/>
        <p>Pas d'autres mois disponibles pour le moment</p>
      </main>
